...
$q = "select customer_id from customer_info where email='$em' and pass='$ps'";
$stmt = mysqli_query($dbc, $q);

// Check the results....
if (mysqli_num_rows($stmt) == 1 ) {
	while($result_1= mysqli_fetch_array ($stmt, MYSQLI_ASSOC)){
		 $_SESSION['customer_id'] = $result_1['customer_id'];
		
	}
	$message = "You have sucessfully loged in.";
...
<form action="login.php" method="post" class="a-box">
<div class="form-group">
    ...
    <div class="form-group">
             ...
             <div class="input-group">
                ...
                <input style="width: 100%" type="email" name="email" for="email" class="form-control" placeholder="Your Email" size="20" maxlength="30" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>" />  
             </div>
            <br>
             <div class="input-group">
                <span class="input-group-addon">
             ...
             <input style="width: 100%" type="password" name="pass" for="pass" class="form-control" placeholder="Your Password" maxlength="20" size="20" value="<?php if (isset($_POST['pass'])) echo $_POST['pass']; ?>" />
             </div>
             <br>
 			<div>
            ...
            <br>
            <div class="form-group">
             <a style="padding: 3%;" href="customer_reg.php">Sign Up Here...</a>
            </div>
